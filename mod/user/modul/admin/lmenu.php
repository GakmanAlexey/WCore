    ...
    public function build($h){
        ...
        $h = $h["lmenu"]["class"]->add_element(
            ...
            $h = $h["lmenu"]["class"]->add_element(
                $h,                         //Хелпер
                "users",                        //Родитель   
                "permisongp",              //Название на латинице
                "Привелегии групп" ,     //Название на Русском
                "permisongp",              //Url адрес
                1,                          //Приоритет
                1,                          //TODO Вид действия
                $ico,                    //Иконка
                "secret.admin"         //Привелегии
            ...
            $h = $h["lmenu"]["class"]->add_element(
                $h,                         //Хелпер
                "users",                        //Родитель   
                "permisonus",              //Название на латинице
                "Привелегии пользователей" ,     //Название на Русском
                "permisonus",              //Url адрес
                1,                          //Приоритет
                1,                          //TODO Вид действия
                $ico,                    //Иконка
                "secret.admin"         //Привелегии

...
<div class="main_crm">
            ...
            <div class="bread">
                    ...
                    <a class="bread_element">Пользователь удален</a>
                </div>

                    <div class="main_crm_content margin_20px_top ">
                    <div class="wrap_contant margin_10_30 linear_spase_between">
                    <h3 class="main_crm_content_h3">Пользователь удален</h3>
                        <a class="icon_button blue" href="/admin/system/users/group/">
                    ...
                    <div class="stroka_info">                        
                        ...
                        <div class="wrap_contant margin_30_l_r">Изменения сохранены</div>                           

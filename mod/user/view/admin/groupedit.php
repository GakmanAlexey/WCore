...
<div class="main_crm">
 ...
 <?php
$val1_def = $h["group"]["data_edit"]["group_name"];
$val2_def = $h["group"]["data_edit"]["name_ru"];
$val1_def2 = $h["group"]["data_edit"]["prefix"];
$val2_def2 = $h["group"]["data_edit"]["ico"];
$html = '
...
$f->add_button($h, "red_group", "crm_button blue", "", "yes", "Сохранить");

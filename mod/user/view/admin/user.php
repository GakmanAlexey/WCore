                ...
                <div class="main_crm_content margin_20px_top ">
                    ...
                    <div class="stroka_info">
                        <div class="stroka_info_title">
                                ...
                                <div class="stroka_redactor_name stroka_text_title stroka_text_elem_2in">Логин</div>
                                <div class="stroka_redactor_dopoln stroka_text_title stroka_text_elem_2in">Электронная почта</div>
                                <div class="redact_3">
                                </div>
                        </div>
...
<?php
$x = 0;
foreach( $h["admin"]["user"]["user_list"] as $item){
    echo '
    <div class="stroka_element">
                                ...
                                <div class="stroka_redactor_name stroka_text_elem stroka_text_elem_2in">'.$item["login"].'</div>
                                <div class="stroka_redactor_dopoln stroka_text_elem stroka_text_elem_2in">'.$item["email"].'</div>
                                <div class="redact_3">
                                    <a href="/admin/users/user/edit/?id='.$item["id"].'"><img src="/src/admin/img/redact.svg" alt=""></a>
                                    <a href="/admin/users/user/delet/?id='.$item["id"].'"><img src="/src/admin/img/delet.svg" alt=""></a>

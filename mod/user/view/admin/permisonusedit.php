...
<div class="main_contant">
    <div class="etap_block">
        ...
        <a href="#" class="etap_element">
            ...
            <p class="etap_element_name etap_blue">Редактирование пользователей</p>
            <svg width="14" height="25" viewBox="0 0 14 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="etap_start etap_blue" d="M0 0H2.1438C3.00593 0 3.82639 0.370903 4.39594 1.01812L12.7559 10.5181C13.7531 11.6512 13.7531 13.3488 12.7559 14.4819L4.39594 23.9819C3.82639 24.6291 3.00593 25 2.1438 25H0V0Z" fill="#E4E5E6"/>
            </svg>   
        </a>
...
<div class="tablica_title_box margin_top_30 margin_bottom_10px">
        ...
        <p class="tablica_title_element width_flex">
            Редактировать привелегий пользователя
        </p>
...
//var_dump($h["admin"]["user"]["use_save_edit_gp_data"]);
    ...
    $h = $af->add_input($h, "name_gp", "text", "parent_inp_input", "", "block", $h["admin"]["user"]["use_save_edit_us_data"]["main_name"], "Логин");
    $h = $af->add_input($h, "id", "text", "parent_inp_input", "", "block2", $h["admin"]["user"]["use_save_edit_us_data"]["id"], "Ид в баззе");
    $h = $af->add_input($h, "aloow", "text", "parent_inp_input", "", 8, $h["admin"]["user"]["use_save_edit_us_data"]["per_on"], "Разрешенные привелегии (через запятую)");
    $h = $af->add_input($h, "disaloow", "text", "parent_inp_input", "", 8, $h["admin"]["user"]["use_save_edit_us_data"]["per_off"], "Запрещенные привелегии (через запятую)");

...
<div class="main_contant">
    <div class="etap_block">
        ...
        <a href="#" class="etap_element">
            ...
            <p class="etap_element_name etap_blue">Удаление группы</p>
            <svg width="14" height="25" viewBox="0 0 14 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="etap_start etap_blue" d="M0 0H2.1438C3.00593 0 3.82639 0.370903 4.39594 1.01812L12.7559 10.5181C13.7531 11.6512 13.7531 13.3488 12.7559 14.4819L4.39594 23.9819C3.82639 24.6291 3.00593 25 2.1438 25H0V0Z" fill="#E4E5E6"/>
            </svg>   
        </a>
...
<div class="main_contant_box">  
 ...
 <?php
    ...
    $h = $af->add_input($h, "name_gp", "text", "parent_inp_input", "", "block", $h["admin"]["user"]["use_save_edit_gp_data"]["main_name"], "Название группы");
    $h = $af->add_input($h, "id", "text", "parent_inp_input", "", "block", $h["admin"]["user"]["use_save_edit_gp_data"]["id"], "Ид группы");
    $h = $af->add_button($h, "go_dell_pex_gp", "form_button red", "", "yes", "Да, удалить");
    $h = $af->build($h);
    $h = $af->render($h);
    ?>      
</div>
